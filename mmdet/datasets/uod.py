#这是我自己定义的文件，用于定义一个 UODDatasets 类
...
class UODDataset(BaseDetDataset):
    """Dataset for URPC."""

    # 根据 URPC 数据集的实际类别和调色板进行修改
    METAINFO = {
        'classes': ('holothurian','echinus', 'scallop', 'starfish'),  # 替换为 UDD实际的类别
        'palette': [(220, 20, 60), (119, 11, 32), (0, 0, 142), (157, 236, 142)]  # 调色板可自定义
    }
