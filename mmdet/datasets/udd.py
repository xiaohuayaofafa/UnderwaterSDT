#这是我自己定义的文件，用于定义一个 UDDDatasets 类
...
class UDDDataset(BaseDetDataset):
    """Dataset for URPC."""

    # 根据 URPC 数据集的实际类别和调色板进行修改
    METAINFO = {
        'classes': ('scallop', 'seacucumber', 'seaurchin'),  # 替换为 UDD实际的类别
        'palette': [(220, 20, 60), (119, 11, 32), (0, 0, 142)]  # 调色板可自定义
    }
